<div class="login__modal--wrapper">
    <form action="" method="post" id="login__modal">
        <div id="login__logo--container">
        ...
        <input type="password" name="password" id="password" class="login__modal--inpt">
        <input type="submit" value="Log In" class="login__modal--inpt" id="login">
    </form>
</div>